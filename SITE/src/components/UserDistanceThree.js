...
function UserDistanceThree(props) {
	const distanceEN = [
		'Distance...',
		'25 m Freestyle',
		'50 m Freestyle',
	...
	const handleCangeTime3 = (name, value) => {
		props.setTime3((prev) => ({
			...prev,
			[name]: value,
		}))
	...
	return (
		...
		>
			...
			<input
				...
				maxLength={2}
				pattern="[0-9]*"
				value={props.time3.mm}
				onChange={(e) => handleCangeTime3('mm', e.target.value)}
				placeholder="mm"
				size={1}
			/>
			:
			<input
				...
				maxLength={2}
				pattern="[0-9]*"
				value={props.time3.ss}
				onChange={(e) => handleCangeTime3('ss', e.target.value)}
				placeholder="ss"
				size={1}
			/>
			.
			<input
				...
				maxLength={2}
				pattern="[0-9]*"
				value={props.time3.ms}
				onChange={(e) => handleCangeTime3('ms', e.target.value)}
				placeholder="ms"
				size={1}
			/>
			<br />
...
export default UserDistanceThree
