...
function UserDistanceTwo(props) {
	const distanceEN = [
		'Distance...',
		'25 m Freestyle',
		'50 m Freestyle',
	...
	const handleCangeTime2 = (name, value) => {
		props.setTime2((prev) => ({
			...prev,
			[name]: value,
		}))
	...
	return (
		...
		>
			...
			<input
				...
				maxLength={2}
				pattern="[0-9]*"
				value={props.time2.mm}
				onChange={(e) => handleCangeTime2('mm', e.target.value)}
				placeholder="mm"
				size={1}
			/>
			:
			<input
				...
				maxLength={2}
				pattern="[0-9]*"
				value={props.time2.ss}
				onChange={(e) => handleCangeTime2('ss', e.target.value)}
				placeholder="ss"
				size={1}
			/>
			.
			<input
				...
				maxLength={2}
				pattern="[0-9]*"
				value={props.time2.ms}
				onChange={(e) => handleCangeTime2('ms', e.target.value)}
				placeholder="ms"
				size={1}
			/>
			<br />
...
export default UserDistanceTwo
